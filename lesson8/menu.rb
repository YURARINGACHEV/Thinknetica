...
# 		when 3
# 			@rail_road.choice_add_type_pass_cargo
# 		when 0
# 			self.choice_main_menu
# 		else 
# 			self.choice_create_rail_road
...
# 	def actions_objects
# 		puts "Введите 0, если хотите вернуться в главное меню"
# 		puts "Введите 1, если хотите добавить к станции или отцепить поезд от станции"
# 		puts "Введите 2, если хотите просматривать список станций и список поездов на станции"
# 		puts "Введите 3, если хотите посмотреть поезда "
# 		input = gets.chomp.to_i
# 	end
...
# 		when 1
# 			puts "Число 1.1"
# 			@rail_road.add_train_on_station
# 		when 2
# 			puts "Число 1.3"
# 			@rail_road.show_station
# 		when 3
